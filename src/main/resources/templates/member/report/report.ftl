...
<div class="content">
	...
	<ul class="memSearch" style="float:left;">
		<li>
			...
			<input id="centerName" type="text" name="centerName" style="width: 339px; height:31px;">
		</li>
		<li>
			<label for="centerCity">Center City</label>
			<input id="centerCity" type="text" name="centerCity" style="width: 339px; height:31px;">
		</li>
		<li>
		...
		<li>
			...
			<input id="centerZipcode" type="text" name="centerZipcode" style="width: 339px; height:31px;">
		</li>
	</ul>
	</#if>
	<ul class="memSearch" <#if loginInfo.userType == "JA"> style="float:right;"</#if>>
		...
		<li>
			...
			<input id="lastName" type="text" name="lastName" style="width: 339px; height:31px;">
		</li>
		<li>
			<label for="firstName">First Name</label>
			<input id="firstName" type="text" name="firstName" style="width: 339px; height:31px;">
		</li>
		<li>
			<label for="homePhone">Home Phone</label>
			<input id="homePhone" type="text" name="homePhone" style="width: 339px; height:31px;">
		</li>
		<li>
			<label for="cellPhone">Cell Phone</label>
			<input id="cellPhone" type="text" name="cellPhone" style="width: 339px; height:31px;">
		</li>
		<li>
			<label for="email">Email</label>
			<input id="email" type="text" name="email" style="width: 339px; height:31px;">
		</li>
		<li>
