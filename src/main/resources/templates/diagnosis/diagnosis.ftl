...
<div class="content">
	...
	<br/>
	<a href="javascript:var a=window.open('/fa/diagnosis/ippr?memKey=AA242162&subj=KP&freejindan=', 'FilePop', 'width=1024,height=800,left=300,scrollbars=yes,resizable=yes');">
		피자 테스트임!!
	</a>
	<br/>
	...
	<a href="javascript:var a=window.open('/fa/diagnosis/adjustmentinput?jisaCD=08&memKey=HK000125&yoil=4&subj=KS', 'engpreview','menubar=no,toolbar=yes,status=no,resizable=yes,scrollbars=yes,width=710,height=480');">
		진도조정
	</a>
