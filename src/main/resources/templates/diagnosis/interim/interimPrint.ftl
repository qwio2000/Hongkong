		...
		<td>
			...
			<!-------------------------------------------------------------------------------------->
				...
				<tr>
					...
					<td bordercolorlight="LightCyan" height="25" class="ver-m">
						&nbsp;받아올림이 없는 (두 자리 수)＋(한 자리 수) 와 (두 자리 수)＋(두 자리 수)
					</td>
					<td align="center" bordercolorlight="LightCyan" class="counsel-m">
						1,5,6
					</td>
				...
				<tr>
					...
					<td bordercolorlight="LightCyan" height="25" class="ver-m">
						&nbsp;받아내림이 없는 (두 자리 수)－(한 자리 수) 와 (두 자리 수)－(두 자리 수)
					</td>
					<td align="center" bordercolorlight="LightCyan" class="counsel-m">
						1,5,6
					</td>
			...
			<table border="0" cellspacing="0" cellpadding="0" width="640">
				<tr>
					<td colspan="9" height="20" class="ver-m"><b><font size=2.5><strong>(6)월의 학습환경</strong></font></b></td>
				</tr>
			</table>
			<table border=1 cellspacing="0" cellpadding="0" width="640" bordercolorlight="LightCyan">
				<tr height="80">
					<td width="640" bordercolorlight="LightCyan" class="ver-m">
						&nbsp;새 학기 초에 세웠던 다짐과 계획이 조금 흐트러질 수 있는 시기입니다.날씨가 더워지면서 정신적으로나 신체적으로 무기력해지기 쉬운 때이므로 능률도 없이 장시간 학습하기 보다는 짧은 시간이라도 규칙적으로 집중력 있게 학습 하도록 하는 것이 효과가 있습니다. 매사에 자신감을 갖고 적극적인 자세를 유지할 수 있도록 하고, 스스로를 격려하면서 긍정적인 사고로 모든 일에 대처할 수 있도록 하는 것이 보다 나은 생활 습관을 유지
					</td>
				</tr>
			</table>
			<table border="0" cellspacing="0" cellpadding="0" width="640" >
