		...
		<div id="content">
			...
			<div id="primary_content" class="primary-content">
				...
				<div class="btn-box float-r">
					<span class="button btn-type-I"><a href="/community/announcementsSP/new">글쓰기</a></span>
				</div> 
			</div>
		</div>
	</div>
...
<script id="announcementsTemplate" type="text/x-handlebars-template">
	{{#each articles}}
		<tr>
			...
			<td>
				<p class="tb_1">
					<a href='/community/announcementsSP/{{boardIdx}}?pageNum={{../pageInfo.pageNum}}'>{{boardSubject}}</a>
				</p>
			</td>
			<td>{{memberId}}</td>
			<td>{{boardRegDate}}</td>
