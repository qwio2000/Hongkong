...
<div class="headerWrap">
	<div class="header">
		...
		<#if jisaAuthInfo??>
		<div class="logout"><a href="/returnjisa"><strong>JISA</strong></a></div>
		</#if>
		<#if bmsAuthInfo??>
		<div class="logout"><a href="/returnbms"><strong>BMS</strong></a></div>
		</#if>
		<h1><a href="/${permLevel }"><img src="${imgPath }/logo.png" alt="JEI Corporate HQ(JEI Korea)" /></a><span>${titleName?default('') } (${loginInfo.userFstName?default('') } ${loginInfo.userLstName?default('') })</span></h1>
